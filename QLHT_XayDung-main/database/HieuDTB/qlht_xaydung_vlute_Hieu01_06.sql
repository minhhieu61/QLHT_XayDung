...
(2, '#DA-IOT-2026', 'Xây dựng hệ thống Lab IoT - Khu C', 'Tầng 3, Nhà C - Khu Lab Công nghệ', NULL, 0.00, 'Khoa Công nghệ thông tin', 'ThS. Nguyễn Văn A', 1, 'Đang thực hiện', '2026-05-05 12:28:52'),
...
(4, '#DA-CL-2026', 'Hệ thống quản lý phòng bệnh cách ly', 'Trung tâm Y tế / Trạm xá VLUTE', NULL, 0.00, 'Phòng Quản trị thiết bị', 'ThS. Phạm Thị C', 3, 'Đang thực hiện', '2026-05-05 12:28:52'),
(5, '#DA-PM-2026', 'Nâng cấp hệ thống mạng máy tính Khu B', 'Toàn bộ dãy nhà Khu B - VLUTE', 'Đang trong tiến trình xây dựng', 0.00, 'Ban Quản lý dự án VLUTE', 'Lê Thị Phương Thảo', 4, 'Hoàn thành', '2026-05-05 12:28:52'),
